        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[70vh] lg:min-h-[80vh]">
          ...
          <div className="text-white space-y-6 lg:space-y-8 animate-fade-in">
            ...
            <div className="flex justify-center gap-4 pt-6 lg:pt-8">
              <div 
                className="bg-background/80 backdrop-blur-md border border-border/50 rounded-xl p-4 lg:p-6 shadow-xl text-center 
                           animate-fade-in hover:scale-105 hover:bg-background/90 hover:shadow-2xl 
                           transition-all duration-300 cursor-pointer group flex-1 max-w-[140px]"
                style={{ animationDelay: '0.2s' }}
              >
                <div className="text-2xl lg:text-3xl font-bold text-primary mb-1 group-hover:scale-110 transition-transform duration-200">20+</div>
                <div className="text-xs lg:text-sm font-medium text-foreground/90">Anos de Experiência</div>
              </div>
              ...
              >
                <div className="text-2xl lg:text-3xl font-bold text-secondary mb-1 group-hover:scale-110 transition-transform duration-200">3</div>
                <div className="text-xs lg:text-sm font-medium text-foreground/90">Anos no Mercado</div>
              </div>
              ...
              >
                <div className="text-2xl lg:text-3xl font-bold text-accent mb-1 group-hover:scale-110 transition-transform duration-200">100km</div>
                <div className="text-xs lg:text-sm font-medium text-foreground/90">Entrega Gratuita</div>
              </div>
            </div>
